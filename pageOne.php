...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($file_size > 500000) { // 500 KB maximum size
        ...
        $sql = "INSERT INTO table_1 (fullname, address, contact, martial_status, emergency_name, emergency_address, emergency_contact, title, department, supervisor, work_location, start_date, salary, image_data) 
        VALUES ('$fullname', '$address', '$contact', '$martialStatus', '$emergencyName', '$emergencyAddress', '$emergencyContact', '$title', '$department', '$supervisor', '$workLocation', '$startDate', '$salary', '$image_data')";

        if (mysqli_query($conn, $sql)) {
            // Success message
            $message = "New record created successfully";
            // Reset form fields
            $_POST['fullname'] = $_POST['address'] = $_POST['contact'] = $_POST['martialStatus'] = $_POST['name'] = $_POST['emergencyAddress'] = $_POST['emergencyContact'] = $_POST['title'] = $_POST['department'] = $_POST['supervisor'] = $_POST['workLocation'] = $_POST['startDate'] = $_POST['salary'] = "";
